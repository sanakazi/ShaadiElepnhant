...
public class asyntask4 extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            Log.w("params are ",urlParameters1 + ", " + urlParameters2 + ", " + urlParameters3+ ", " + urlParameters4+ ", " + urlParameters5 );
            wr.writeBytes(urlParameters1+"&"+urlParameters2+"&"+urlParameters3+"&"+urlParameters4+"&"+urlParameters5);
            wr.flush();
            wr.close();
