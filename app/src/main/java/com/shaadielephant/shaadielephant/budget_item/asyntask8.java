 ...
 */
public class asyntask8 extends AsyncTask<String, Void, String> {
    StringBuffer response;
    Context context;
    static networkresponse8 objlistner;
    customProgressDialog progressDialog;

    public asyntask8(Context c) {
        this.context = c;
    }

    public static void setListner(networkresponse8 objnetworkresponse) {
    ...
    protected void onPostExecute(String s) {
        ...
        if(response!=null)
            objlistner.getResponse8(response.toString());
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            Log.w("params are 8 ", " " + urlParameters1+","+urlParameters2+","+urlParameters3+","+urlParameters4+","+urlParameters5+","+urlParameters6+","+urlParameters7);
